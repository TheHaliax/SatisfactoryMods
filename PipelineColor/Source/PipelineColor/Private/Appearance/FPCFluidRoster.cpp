...
const TArray<FPCFluidRosterRow>& FluidRows()
{
	...
	Add(TEXT("/Game/FactoryGame/Resource/RawResources/Water/Desc_Water.Desc_Water_C"),
		TEXT("Water"), 0x7A, 0xB0, 0xD4, EPCPaintFinishKind::Default,
		UPCSwatchDesc_Water::StaticClass(), UPCSwatchRecipe_Water::StaticClass());
	...
	Add(TEXT("/Game/FactoryGame/Resource/Parts/Fuel/Desc_LiquidFuel.Desc_LiquidFuel_C"),
		TEXT("Fuel"), 0xEB, 0x7D, 0x15, EPCPaintFinishKind::Default,
		UPCSwatchDesc_Fuel::StaticClass(), UPCSwatchRecipe_Fuel::StaticClass());
