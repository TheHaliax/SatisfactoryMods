...
void UPCSwatchRecipeBase::InitRecipe(
	TSubclassOf<UFGFactoryCustomizationDescriptor_Swatch> Desc,
	const TCHAR* DisplayName)
{
	...
	mProducedIn.Reset();
	mProducedIn.Add(TSoftClassPtr<UObject>(FSoftObjectPath(TEXT(
