...
void InitSwatch(UPCSwatchDescBase* Self, const FText& Name, FName Key)
{
	...
	Self->mDescription = NSLOCTEXT(
		"PipelineColor",
		"SwatchDesc",
		"PipelineColor fluid swatch");
...
{
	InitSwatch(this, NSLOCTEXT("PipelineColor", "SwatchWater", "PC Water"),
		FName(TEXT("Water")));
}
...
{
	InitSwatch(this,
		NSLOCTEXT("PipelineColor", "SwatchHeavyOilResidue", "PC Heavy Oil Residue"),
		FName(TEXT("HeavyOilResidue")));
}

UPCSwatchDesc_Fuel::UPCSwatchDesc_Fuel()
{
	InitSwatch(this, NSLOCTEXT("PipelineColor", "SwatchFuel", "PC Fuel"),
		FName(TEXT("Fuel")));
}
...
{
	InitSwatch(this,
		NSLOCTEXT("PipelineColor", "SwatchLiquidBiofuel", "PC Liquid Biofuel"),
...
{
	InitSwatch(this,
		NSLOCTEXT("PipelineColor", "SwatchAluminaSolution", "PC Alumina Solution"),
...
{
	InitSwatch(this,
		NSLOCTEXT("PipelineColor", "SwatchDissolvedSilica", "PC Dissolved Silica"),
...
{
	InitSwatch(this,
		NSLOCTEXT("PipelineColor", "SwatchDarkMatterResidue", "PC Dark Matter Residue"),
...
UPCSwatchDesc_ExcitedPhotonicMatter::UPCSwatchDesc_ExcitedPhotonicMatter()
{
	InitSwatch(this,
		NSLOCTEXT(
			"PipelineColor",
			"SwatchExcitedPhotonicMatter",
			"PC Excited Photonic Matter"),
