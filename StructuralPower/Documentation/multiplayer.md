...
**I-key Id panel** runs on the local client; apply sends RCO to server. All players need matching **3.1.2** (or compatible `^3.0.0`) for the panel UI and machine groups.
...
| Symptom | Check |
|---------|--------|
| Mod missing on join | All parties on SMR 3.1.2, SML ^3.12.0 |
