...
class STRUCTURALPOWER_API FStructuralEndpointIdRegistry {
 public:
  ...
  void Bind(TMap<FStructuralComponentKey, FName>& InComponentDefaultIds,
  ...
  bool TryGetPlayerOverride(const FStructuralNodeId& NodeId,
  ...
  void ApplyPlayerOverrideEdits(const FStructuralNodeId& NodeId, FName Source, FName Control,
