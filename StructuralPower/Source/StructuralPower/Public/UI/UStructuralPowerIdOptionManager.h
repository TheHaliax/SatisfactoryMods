...
UCLASS()
class STRUCTURALPOWER_API UStructuralPowerIdOptionManager : public UObject,
                                                            public IFGOptionInterfaceImpl {
  GENERATED_BODY()
 ...
 private:
  ...
  void ResetSettings();
  UFGUserSetting* CreateDropdownSetting(const FString& SettingId, const FText& Label,
                                        const TArray<FName>& Options, int32 DefaultIndex);
