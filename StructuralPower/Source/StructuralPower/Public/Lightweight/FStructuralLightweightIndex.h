...
class STRUCTURALPOWER_API FStructuralLightweightIndex {
 public:
  ...
  static bool AreBoundsStructurallyConnected(const FBox& A, const FBox& B,
 ...
 private:
  ...
  static FBox GetWorldBounds(TSubclassOf<AFGBuildable> BuildableClass, const FTransform& Transform,
