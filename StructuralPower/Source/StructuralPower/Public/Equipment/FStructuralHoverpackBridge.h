...
private:
	...
	static bool FindNearestVisibleConnector(
		AFGHoverPack* Pack,
		float MaxDistance,
		...
		FVector& OutAnchor,
		float& OutDistance);
	static bool FindStructuralTether(
		AFGHoverPack* Pack,
		float MaxHorizontal,
		float MaxVertical,
		UFGPowerConnectionComponent*& OutFeed,
	...
	static void PublishStructuralTetherToOwningClient(
		AFGHoverPack* Pack,
		FStructuralHoverpackSession& Session,
		bool bClear);
	...
	static bool ShouldPublishSessionToVanilla(
		const AFGHoverPack* Pack,
		const FStructuralHoverpackSession& Session);
	static bool ResolvePublishedTether(
		const AFGHoverPack* Pack,
		FVector& OutAnchor,
		float& OutMaxHorizontal,
		float& OutMaxVertical,
