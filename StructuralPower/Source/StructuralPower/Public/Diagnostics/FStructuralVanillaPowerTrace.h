...
namespace FStructuralVanillaPowerTrace
{
	...
	void OnConnectComponentsEnter(
		AFGCircuitSubsystem* Subsystem,
		UFGCircuitConnectionComponent* First,
		UFGCircuitConnectionComponent* Second);
	void OnConnectComponentsExit(
		AFGCircuitSubsystem* Subsystem,
		UFGCircuitConnectionComponent* First,
		UFGCircuitConnectionComponent* Second);

	void OnDisconnectComponentsEnter(
		AFGCircuitSubsystem* Subsystem,
		UFGCircuitConnectionComponent* First,
		UFGCircuitConnectionComponent* Second);
	void OnDisconnectComponentsExit(
		AFGCircuitSubsystem* Subsystem,
		UFGCircuitConnectionComponent* First,
		UFGCircuitConnectionComponent* Second);

	void OnAddHiddenConnectionEnter(
		UFGCircuitConnectionComponent* Self,
		UFGCircuitConnectionComponent* Other);
	void OnAddHiddenConnectionExit(
		UFGCircuitConnectionComponent* Self,
		UFGCircuitConnectionComponent* Other);

	void OnRemoveHiddenConnectionEnter(
		UFGCircuitConnectionComponent* Self,
		UFGCircuitConnectionComponent* Other);
	void OnRemoveHiddenConnectionExit(
		UFGCircuitConnectionComponent* Self,
		UFGCircuitConnectionComponent* Other);

	void OnAddWireConnectionEnter(
		UFGCircuitConnectionComponent* Self,
		AFGBuildableWire* Wire);
	void OnAddWireConnectionExit(
		UFGCircuitConnectionComponent* Self,
		AFGBuildableWire* Wire);

	void OnRemoveWireConnectionEnter(
		UFGCircuitConnectionComponent* Self,
		AFGBuildableWire* Wire);
	void OnRemoveWireConnectionExit(
		UFGCircuitConnectionComponent* Self,
		AFGBuildableWire* Wire);
	...
	void OnPolePowerConnectionChanged(
