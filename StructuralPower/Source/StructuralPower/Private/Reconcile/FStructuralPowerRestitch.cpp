...
bool FStructuralPowerRestitch::ShouldEndpointParticipateInRestitch(AFGBuildable* Host,
...
bool FStructuralPowerRestitch::ShouldMeshEndpoints(AFGBuildable* HostA, AFGBuildable* HostB,
  ...
  return FStructuralPowerRouter::ShouldRouteKeyedJoin(SwitchControl, DeviceSource, CompKey,
                                                      CompKey);
}
