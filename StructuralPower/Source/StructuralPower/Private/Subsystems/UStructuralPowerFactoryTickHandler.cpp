...
void UStructuralPowerFactoryTickHandler::UnregisterGlobalDelegates() {
  ...
  for (const TPair<TWeakObjectPtr<UWorld>, TObjectPtr<UStructuralPowerFactoryTickHandler>>& Pair :
       Handlers) {
...
void UStructuralPowerFactoryTickHandler::HandleWorldCleanup(UWorld* World, bool /*bSessionEnded*/,
...
void UStructuralPowerFactoryTickHandler::RegisterForWorld(UWorld* World) {
  ...
  UStructuralPowerFactoryTickHandler* Handler =
      NewObject<UStructuralPowerFactoryTickHandler>(World);
...
void UStructuralPowerFactoryTickHandler::PostFactoryTick(AFGBuildableSubsystem* /*Subsystem*/,
                                                         float /*DeltaTime*/) {
