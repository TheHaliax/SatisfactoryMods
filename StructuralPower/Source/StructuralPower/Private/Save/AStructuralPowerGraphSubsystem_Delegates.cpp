...
bool AStructuralPowerGraphSubsystem::LinkHiddenPair(UFGPowerConnectionComponent* A,
                                                    UFGPowerConnectionComponent* B,
                                                    bool bPromoteCircuit) {
  return CircuitOps.LinkHiddenPair(A, B, bPromoteCircuit);
}

bool AStructuralPowerGraphSubsystem::LinkHiddenPairLocal(UFGPowerConnectionComponent* A,
                                                         UFGPowerConnectionComponent* B,
                                                         bool bPromoteCircuit) {
...
void AStructuralPowerGraphSubsystem::AddEndpointToRootIndex(int32 Root,
...
bool AStructuralPowerGraphSubsystem::IsPanelSupplyLinked(UFGPowerConnectionComponent* InputPower,
...
int32 AStructuralPowerGraphSubsystem::ResolvePoleComponentRoot(AFGBuildablePowerPole* Pole,
...
bool AStructuralPowerGraphSubsystem::ShouldDeferCircuitDrivenRefresh() const {
  return bBulkLoadDrainActive || bPendingPostLoadLightReconcile ||
         bPendingPostLoadMachineReconcile || bPendingFinalLightingReconcile ||
         bPendingStructureSplitReconcile || CircuitPromotionDepth > 0;
}
...
bool AStructuralPowerGraphSubsystem::GetEndpointOverrides(const AFGBuildable* Buildable,
...
FName AStructuralPowerGraphSubsystem::ResolveSource(AFGBuildable* Buildable,
                                                    EStructuralChannel Tag) {
  return IdOps.ResolveSource(Buildable, Tag);
}

FName AStructuralPowerGraphSubsystem::ResolveControl(AFGBuildable* Buildable,
                                                     EStructuralChannel Tag) {
...
void AStructuralPowerGraphSubsystem::SetEndpointIds(AFGBuildable* Buildable, FName Source,
                                                    FName Control, bool bClearSource,
                                                    bool bClearControl, const bool bGlobalControl,
                                                    const bool bTouchGlobalControl) {
  IdOps.SetEndpointIds(Buildable, Source, Control, bClearSource, bClearControl, bGlobalControl,
                       bTouchGlobalControl);
}

bool AStructuralPowerGraphSubsystem::CollectIdsOnComponent(const FStructuralComponentKey& Key,
...
void AStructuralPowerGraphSubsystem::RebuildControlIdGangsForRoot(const int32 ComponentRoot) {
  ...
  auto RegisterPublisher = [&](const FStructuralNodeId& NodeId, AFGBuildable* Buildable) {
    ...
    GangKey.Scope =
        bGlobal ? EStructuralControlGangScope::Global : EStructuralControlGangScope::Site;
...
int32 AStructuralPowerGraphSubsystem::ResolveEndpointComponentRoot(
    AFGBuildable* Endpoint, const FStructuralWallAnchor& Anchor, FStructuralNodeId& OutParentId) {
...
int32 AStructuralPowerGraphSubsystem::ResolveBridgeHostComponentRoot(
    AFGBuildable* Host, FStructuralNodeId* OutParentId) {
...
void AStructuralPowerGraphSubsystem::ScheduleFinalLightingReconcile() {
  ...
  World->GetTimerManager().SetTimerForNextTick(
      FTimerDelegate::CreateWeakLambda(this, [this]() { MaybeRunFinalLightingReconcile(); }));
}

void AStructuralPowerGraphSubsystem::ScheduleStructureSplitReconcile() {
  if (bPendingStructureSplitReconcile) {
    return;
  }
  ...
  World->GetTimerManager().SetTimerForNextTick(FTimerDelegate::CreateWeakLambda(
      this, [this]() { GetGraphSession().Removal().RunStructureSplitReconcile(); }));
}

bool AStructuralPowerGraphSubsystem::IsDirectSwitchFedLight(int32 Root,
                                                            const FStructuralChannelKey& LightKey) {
  return ReconcileOps.IsDirectSwitchFedLight(Root, LightKey);
}

bool AStructuralPowerGraphSubsystem::IsPanelDownstreamLight(int32 Root,
                                                            const FStructuralChannelKey& LightKey) {
  return ReconcileOps.IsPanelDownstreamLight(Root, LightKey);
}

bool AStructuralPowerGraphSubsystem::IsSwitchFeedOpen(int32 Root, FName SwitchControlId) {
...
bool AStructuralPowerGraphSubsystem::EnsureParentRegisteredInGraph(
    const FStructuralWallAnchor& Anchor, FStructuralNodeId& OutParentId) {
...
bool AStructuralPowerGraphSubsystem::DoesComponentRootCarryPower(int32 ComponentRoot) const {
  return const_cast<AStructuralPowerGraphSubsystem*>(this)->CircuitOps.DoesComponentRootCarryPower(
      ComponentRoot);
}
...
bool AStructuralPowerGraphSubsystem::FindNearestStructureAnchorForEquipment(
    const FVector& QueryLoc, float MaxHorizontal, float MaxVertical, FVector& OutAnchor,
    int32& OutComponentRoot) const {
  return StructureGraph.FindNearestStructureAnchor(QueryLoc, MaxHorizontal, MaxVertical, OutAnchor,
                                                   OutComponentRoot);
}

bool AStructuralPowerGraphSubsystem::QueryHoverpackStructuralAnchor(
    const FVector& QueryLoc, float MaxHorizontal, float MaxVertical,
    FStructuralHoverpackAnchorQuery& Out) const {
  return FStructuralEquipmentBridgeRegistry::Get().QueryHoverpackStructuralAnchor(
      const_cast<AStructuralPowerGraphSubsystem*>(this)->GetGraphSession(), QueryLoc, MaxHorizontal,
      MaxVertical, Out);
}
...
bool AStructuralPowerGraphSubsystem::ShouldMeshEndpoints(AFGBuildable* HostA, AFGBuildable* HostB,
                                                         int32 ComponentRoot) const {
...
void AStructuralPowerGraphSubsystem::ProcessSwitchCircuitsRebuilt(
...
bool AStructuralPowerGraphSubsystem::ShouldSkipPanelCircuitEcho(
    AFGBuildableLightsControlPanel* Panel, const TCHAR** OutReason) {
  return GetGraphSession().CircuitEcho().ShouldSkipPanelCircuitEcho(Panel, OutReason);
}

bool AStructuralPowerGraphSubsystem::ShouldSkipSwitchCircuitEcho(AFGBuildableCircuitSwitch* Switch,
                                                                 const TCHAR** OutReason) {
  return GetGraphSession().CircuitEcho().ShouldSkipSwitchCircuitEcho(Switch, OutReason);
}

void AStructuralPowerGraphSubsystem::MarkEchoDirtyForSwitchToggle(AFGBuildableCircuitSwitch* Switch,
                                                                  int32 LocalRoot) {
...
void AStructuralPowerGraphSubsystem::NotePanelToggleHandled(AFGBuildableLightsControlPanel* Panel) {
...
void AStructuralPowerGraphSubsystem::NoteSwitchToggleHandled(AFGBuildableCircuitSwitch* Switch) {
...
void AStructuralPowerGraphSubsystem::EnumerateTrackedLightsOnRoot(
    int32 Root, TFunctionRef<void(AFGBuildableLightSource*)> Visitor) {
...
void AStructuralPowerGraphSubsystem::ReconcileGroupGenerationState() {
  ReconcileOps.ReconcileGroupGenerationState();
}

void AStructuralPowerGraphSubsystem::ReconcileGroupResourcesState() {
  ReconcileOps.ReconcileGroupResourcesState();
}

void AStructuralPowerGraphSubsystem::ReconcileGroupProductionState() {
  ReconcileOps.ReconcileGroupProductionState();
}

void AStructuralPowerGraphSubsystem::ReconcileGroupTransportState() {
  ReconcileOps.ReconcileGroupTransportState();
}

void AStructuralPowerGraphSubsystem::ReconcileGroupPipesState() {
  ReconcileOps.ReconcileGroupPipesState();
}

void AStructuralPowerGraphSubsystem::RefreshPanelsForLightSourceOnRoot(int32 Root,
                                                                       FName LightSource) {
