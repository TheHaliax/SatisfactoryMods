...
bool FStructuralPowerIdFieldMatrix::Build(UWidgetTree* WidgetTree, UVerticalBox* ContentVBox,
  ...
  UTextBlock* Subtitle =
      WidgetTree->ConstructWidget<UTextBlock>(UTextBlock::StaticClass(), TEXT("Subtitle"));
  ...
  UTextBlock* Hint =
      WidgetTree->ConstructWidget<UTextBlock>(UTextBlock::StaticClass(), TEXT("HintText"));
  FString HintLine;
  if (FStructuralEligibilityRules::IsStructuralGenerator(TargetBuildable)) {
    ...
    HintLine =
        FString::Printf(TEXT("Light source id must match panel control id. Group Lighting: %s."),
  ...
  OutWidgets.ActiveIdsText =
      WidgetTree->ConstructWidget<UTextBlock>(UTextBlock::StaticClass(), TEXT("ActiveIdsText"));
  ...
  auto AddSuggestedSection = [&](const TCHAR* SectionLabel, const TCHAR* CustomLabel,
                                 const TCHAR* ComboName, const TCHAR* TextName,
                                 TObjectPtr<UComboBoxString>& OutCombo,
                                 TObjectPtr<UEditableTextBox>& OutText, int32 OptionCount,
                                 TFunctionRef<FName(int32)> GetOptionAt) {
    UTextBlock* SuggestedLabel = WidgetTree->ConstructWidget<UTextBlock>(
        UTextBlock::StaticClass(), *FString::Printf(TEXT("%sLabel"), ComboName));
    ...
    USizeBox* ComboHost = WidgetTree->ConstructWidget<USizeBox>(
        USizeBox::StaticClass(), *FString::Printf(TEXT("%sHost"), ComboName));
    ComboHost->SetMinDesiredHeight(36.0f);

    OutCombo =
        WidgetTree->ConstructWidget<UComboBoxString>(UComboBoxString::StaticClass(), ComboName);
    ...
    UTextBlock* CustomTextLabel = WidgetTree->ConstructWidget<UTextBlock>(
        UTextBlock::StaticClass(), *FString::Printf(TEXT("%sCustomLabel"), TextName));
    ...
    USizeBox* TextHost = WidgetTree->ConstructWidget<USizeBox>(
        USizeBox::StaticClass(), *FString::Printf(TEXT("%sHost"), TextName));
    TextHost->SetMinDesiredHeight(36.0f);

    OutText =
        WidgetTree->ConstructWidget<UEditableTextBox>(UEditableTextBox::StaticClass(), TextName);
  ...
  if (bShowSource) {
    AddSuggestedSection(
        TEXT("Suggested source id"), TEXT("Custom source id"), TEXT("SuggestedSourceCombo"),
        TEXT("AssignSourceText"), OutWidgets.SuggestedSourceCombo, OutWidgets.AssignSourceText,
  ...
  if (bShowControl) {
    AddSuggestedSection(
        TEXT("Suggested control id"), TEXT("Custom control id"), TEXT("SuggestedControlCombo"),
        TEXT("AssignControlText"), OutWidgets.SuggestedControlCombo, OutWidgets.AssignControlText,
    ...
    if (TargetBuildable->IsA<AFGBuildableCircuitSwitch>()) {
      UHorizontalBox* GlobalRow = WidgetTree->ConstructWidget<UHorizontalBox>(
          UHorizontalBox::StaticClass(), TEXT("GlobalControlRow"));
      OutWidgets.GlobalControlCheck = WidgetTree->ConstructWidget<UCheckBox>(
          UCheckBox::StaticClass(), TEXT("GlobalControlCheck"));
      ...
      UTextBlock* GlobalLabel = WidgetTree->ConstructWidget<UTextBlock>(UTextBlock::StaticClass(),
                                                                        TEXT("GlobalControlLabel"));
      SetTextStyle(GlobalLabel, TEXT("Global control (all sites)"), 12);
  ...
  UHorizontalBox* ButtonRow =
      WidgetTree->ConstructWidget<UHorizontalBox>(UHorizontalBox::StaticClass(), TEXT("ButtonRow"));
  ...
  UE_LOG(
      ...
      bDual ? 1 : 0, bShowSource ? 1 : 0, bShowControl ? 1 : 0,
      OptionManager->GetSourceOptionCount(), OptionManager->GetControlOptionCount());
