...
public:
		...
		const FKeyEvent& InKeyEvent) override
	{
		...
		UStructuralPowerIdConfigWidget* Active =
			FStructuralPowerIdWindowPool::GetActiveWidget();
...
void FStructuralPowerIdModalHost::ScheduleModalInputModeRefresh(UStructuralPowerIdConfigWidget* Widget)
{
	if (!IsValid(Widget))
	{
		return;
...
void FStructuralPowerIdModalHost::ForceReleaseAllModalState(
...
void FStructuralPowerIdModalHost::OnPanelOpened(
...
void FStructuralPowerIdModalHost::OnPanelClosed(
	UStructuralPowerIdConfigWidget* Widget,
	AFGPlayerController* PC)
{
	if (IsValid(PC))
