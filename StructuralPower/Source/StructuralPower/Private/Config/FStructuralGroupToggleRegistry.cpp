...
bool FStructuralGroupToggleRegistry::IsChannelRoutingEnabled(const EStructuralChannel Channel) const
{
...
const FStructuralGroupToggleDef* FStructuralGroupToggleRegistry::FindByKey(const FName ConfigKey) const
{
	for (const FStructuralGroupToggleDef& Def : Definitions)
	{
